        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8 relative">
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 bg-highlight transform -translate-x-full group-hover:translate-x-0 transition-transform duration-400 [transition-timing-function:cubic-bezier(0.16,1,0.3,1)]" />
            </button>
          </form>
